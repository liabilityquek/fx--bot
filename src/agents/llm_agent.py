...
Provider priority:
  ...
  2. Anthropic  (claude-haiku-4-5-20251001 by default) — activates when Groq credits are exhausted
  3. HOLD fallback — when all providers are credit-exhausted; DecisionEngine
